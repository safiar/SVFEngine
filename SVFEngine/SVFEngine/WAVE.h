...
// MODULE  : WAVE.h
//
// PURPOSE : Описание звукового формата .wav
//
...
struct WAVERIFF
{
	...
	unsigned __int32 format;			//>> 'WAVE'  57 41 56 45
	unsigned __int32 subchunk1Id;		//>> 'fmt '  66 6d 74 20
	...
	unsigned __int32 byteRate;			//>> Всего байт в секунду
	unsigned __int16 blockAlign;		//>> Всего байт одного семпла (все каналы)
	unsigned __int16 bitsPerSample;		//>> Всего бит в семпле (глубина звучания) : 8, 16, 24, 32
	// ...
	// возможно ещё данные
	// ...
